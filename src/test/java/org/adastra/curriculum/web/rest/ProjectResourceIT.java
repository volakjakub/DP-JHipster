...
import static org.adastra.curriculum.domain.ProjectAsserts.*;
...
class ProjectResourceIT {
    ...
    void putExistingProject() throws Exception {
        ...
        updatedProject.name(UPDATED_NAME).client(UPDATED_CLIENT).start(UPDATED_START).end(UPDATED_END).description(UPDATED_DESCRIPTION);
    ...
    void partialUpdateProjectWithPatch() throws Exception {
        ...
        partialUpdatedProject.client(UPDATED_CLIENT).end(UPDATED_END);
