...
export const ConfigurationPage = () => {
  ...
  return (
    <div>
      ...
      <span>Filtrovat (podle předpony)</span> <Input type="search" value={filter} onChange={changeFilter} name="search" id="search" />
      <label>Spring configuration</label>
      <Table className="table table-striped table-bordered table-responsive d-table">
        <thead>
          <tr>
            <th onClick={changeReversePrefix}>Předpona</th>
            <th onClick={changeReverseProperties}>Vlastnosti</th>
          </tr>
        </thead>
        <tbody>
