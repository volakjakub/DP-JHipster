      ...
      <h2 id="user-management-page-heading" data-cy="userManagementPageHeading">
        ...
        <div className="d-flex justify-content-end">
          ...
          <Link to="new" className="btn btn-primary jh-create-entity">
            <FontAwesomeIcon icon="plus" /> Vytvořit nového uživatele
          </Link>
        </div>
      </h2>
        ...
        <thead>
          <tr>
            ...
            <th className="hand" onClick={sort('login')}>
              Uživatelské jméno <FontAwesomeIcon icon={getSortIconByFieldName('login')} />
            </th>
            ...
            <th className="hand" onClick={sort('createdDate')}>
              Vytvořeno <FontAwesomeIcon icon={getSortIconByFieldName('createdDate')} />
            </th>
            <th className="hand" onClick={sort('lastModifiedBy')}>
              Upravil/a <FontAwesomeIcon icon={getSortIconByFieldName('lastModifiedBy')} />
            </th>
            <th id="modified-date-sort" className="hand" onClick={sort('lastModifiedDate')}>
              Upraveno <FontAwesomeIcon icon={getSortIconByFieldName('lastModifiedDate')} />
            </th>
            <th />
          </tr>
        </thead>
