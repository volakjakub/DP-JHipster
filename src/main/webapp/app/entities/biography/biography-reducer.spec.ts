...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './biography.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BIOGRAPHY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BIOGRAPHY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BIOGRAPHY actions', async () => {
      const arg = { id: 32367 };
    ...
    it('dispatches UPDATE_BIOGRAPHY actions', async () => {
      const arg = { id: 32367 };
    ...
    it('dispatches PARTIAL_UPDATE_BIOGRAPHY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BIOGRAPHY actions', async () => {
      const arg = 42666;
